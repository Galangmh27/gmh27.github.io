        ...
        <div class="main app form" id="main">
            ...
            <div class="hero-section">
                <div class="container">
                    <div class="card">
                        <div class="mb-30">
                            <p class="text-center  mb-10">Isi Buku Tamu</p>
                            <p class="text-center nonecase-font text-light">Masukkan data anda
                                di
                                bawah
                                ini
                            </p>
                        ...
                        <div class="form wow fadeInUp" data-wow-delay="0.3s">
                            <form class="subscribe-form" action="aksi.php" method="post">
                                <div class="mb-3">
                                    <label for="form-nama" class="form-label">Nama</label>
                                    <input type="text" class="form-control shadow-sm" name="nama" id="form-nama"
                                        placeholder="Masukan Nama Anda" />
                                </div>
                                <div class="mb-3">
                                    <label for="form-alamat" class="form-label">Alamat</label>
                                    <input type="text" class="form-control shadow-sm" name="alamat" id="form-nama"
                            ...
                            <div class="button-group text-center">
                                <a href="../index.html" class="btn btn-info btn-success btn-rounded">Kembali
                                </a>
                                <a href="datatamu.php" class="btn btn-info btn-success btn-rounded">Data
                                    Tamu
                                </a>
                            </div>
                        </div>
